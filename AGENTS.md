...
For detailed API development guidelines including DTOs, naming conventions, and best practices, see [src/Deckle.API/API_GUIDELINES.md](src/Deckle.API/API_GUIDELINES.md).
