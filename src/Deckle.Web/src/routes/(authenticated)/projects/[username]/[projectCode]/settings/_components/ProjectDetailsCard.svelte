...
<style>
  ...
  .desc-preview :global(a) { color: var(--color-secondary-fg); text-decoration: underline; }
  ...
  .desc-rendered :global(a) { color: var(--color-secondary-fg); text-decoration: underline; }
